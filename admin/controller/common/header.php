...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		if (!isset($this->request->get['user_token']) || !isset($this->session->data['user_token']) || ($this->request->get['user_token'] != $this->session->data['user_token'])) {
			...
			$data['new_blog_article'] = $this->url->link('blog/article/add', 'user_token=' . $this->session->data['user_token'], true);
			$data['new_blog_category'] = $this->url->link('blog/category/add', 'user_token=' . $this->session->data['user_token'], true);
			$data['new_filter_value'] = $this->url->link('catalog/filter/add', 'user_token=' . $this->session->data['user_token'], true);
			$data['new_filter_page'] = $this->url->link('catalog/filter_pages/add', 'user_token=' . $this->session->data['user_token'], true);
			$data['new_order'] = $this->url->link('sale/order/add', 'user_token=' . $this->session->data['user_token'], true);
