	...
	public function addOption($data) {
		...
		if (isset($data['option_value'])) {
			foreach ($data['option_value'] as $option_value) {
				if (!isset($option_value['default_option']) || (isset($option_value['default_option']) && $option_value['default_option'] !== '1')) {
					$option_value['default_option'] = '0';
				}
				$this->db->query("
					...
					SET 
						...
						default_option = '" . (int)$option_value['default_option'] . "'
					");
