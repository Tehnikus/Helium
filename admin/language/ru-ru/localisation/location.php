...
$_['column_sort_order'] = 'Порядок отображения';
...
$_['entry_map']         = '&lt;iframe&gt; код карты';
$_['help_map']          = 'Зайдите на Google Maps, найдите свой адрес, нажмите Поделиться и в меню выберите HTML код. Код скопируйте сюда';
