		...
		if (isset($articles) && !empty($articles)) {
			...
			foreach ($articles as $key => $article) {
				...
				if (isset($article['image']) && $article['image'] !== '') {
					...
					$articles[$key]['image'] = $this->model_tool_image->resize('no_image.webp', $this->config->get('article_miniature_image_width'), $this->config->get('article_miniature_image_height'));
				}
			}
		}
		return $articles;
