	...
	public function index() {
		...
		if ($category_info) {
			...
			if ($category_info['image']) {
				...
				$data['thumb'] = $this->model_tool_image->resize('no_image.webp', $this->config->get('configblog_image_category_width'), $this->config->get('configblog_image_category_height'));
			}

			$data['width'] = $this->config->get('configblog_image_category_width');
			$data['height'] = $this->config->get('configblog_image_category_height');
			...
			foreach ($results as $result) {
				if ($result['image']) {
					...
					$image = $this->model_tool_image->resize('no_image.webp', $this->config->get('configblog_image_article_width'), $this->config->get('configblog_image_article_height'));
				}
				...
				$data['articles'][] = array(
					...
					'thumb'       => $image,
					'width'		  => $this->config->get('configblog_image_article_width'),
					'height'	  => $this->config->get('configblog_image_article_height'),
					'name'        => $result['name'],
