...
class ControllerProductSearch extends Controller {
	public function index() {
		...
		if (isset($this->request->get['search'])) {
			...
			// Todo Сделать страницы с тегами индексируемыми и со статичными урлами
	...
	public function find()
	{
		...
		if (isset($this->request->post['search']) && !empty($this->request->post['search'])) {
			$search_string = $this->request->post['search'];
			...
			foreach ($products as $key => $product) {
				...
				// Highlight search words in product description
				$description = '';
