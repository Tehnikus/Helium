...
$_['text_pagination']           = 'Показано з <span class="from">%s</span> по <span class="to">%d</span> із %s товарів, (сторінок: %d)';
$_['text_review_pagination']    = 'Показано з <span class="from">%s</span> по <span class="to">%d</span> із %s відгуків, (сторінок: %d)';
...
$_['button_wishlist']           = 'В список бажань';
...
$_['button_new_address']        = 'Додати нову адресу';
