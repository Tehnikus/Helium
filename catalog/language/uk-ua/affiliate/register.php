...
$_['entry_paypal']              = 'Email облікового запису PayPal';
$_['entry_bank_name']           = 'Найменування банку';
$_['entry_bank_branch_number']  = 'Номер відділення';
$_['entry_bank_swift_code']     = 'Swift номер';
...
$_['error_telephone']           = 'Номер телефону повинен має бути від 3 до 32 символів';
$_['error_password']            = 'Пароль має бути від 4 до 20 символів';
$_['error_confirm']             = 'Помилка в підтвердженні пароля';
...
$_['error_agree']               = 'Для продовження необхідно прочитати та погодитися з %s';