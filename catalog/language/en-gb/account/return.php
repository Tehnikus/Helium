...
$_['entry_captcha']      = 'Solve captcha';

// Error
$_['text_error']         = 'The returns you requested could not be found';
$_['error_order_id']     = 'Order ID required';
$_['error_firstname']    = 'Firstname must be between 1 and 32 characters';
$_['error_lastname']     = 'Lastname must be between 1 and 32 characters';
$_['error_email']        = 'E-Mail does not appear to be valid';
$_['error_telephone']    = 'Telephone must be between 3 and 32 characters';
$_['error_product']      = 'Select product to be returned';
$_['error_model']        = 'Product Model must be greater than 3 and less than 64 characters';
$_['error_reason']       = 'You must select a return product reason';
$_['error_agree']        = 'Warning: You must agree to the %s';
$_['error_comment']      = 'Please describe your return reason';
$_['error_quantity']     = 'Enter product quantity you wish to return, maximum %s pcs.';
$_['error_captcha']      = 'Captcha is incorrect, mr. Robot!';