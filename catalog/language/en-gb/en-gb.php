...
$_['text_pagination']       = 'Showing <span class="from">%s</span> to <span class="to">%d</span> of %d products (%d pages)';
$_['text_review_pagination']= 'Showing  <span class="from">%s</span> to <span class="to">%d</span> of %s reviews, (%d pages)';
$_['aria_rating_label']     = 'Rating'; 
$_['aria_review_count_label'] = 'reviews';
